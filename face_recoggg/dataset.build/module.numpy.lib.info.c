/* Generated code for Python module 'numpy.lib.info'
...
static PyObject *const_str_digest_db87ea6d868d2435f6a34cac0e42d1a7;
...
{
    const_str_digest_db87ea6d868d2435f6a34cac0e42d1a7 = UNSTREAM_STRING_ASCII( &constant_bin[ 893016 ], 17, 0 );
    const_str_digest_7d8134536515680674da910bddb241f8 = UNSTREAM_STRING_ASCII( &constant_bin[ 893033 ], 14, 0 );
    ...
    const_str_digest_f89d5e2441d80b29b22ac56aab63c345 = UNSTREAM_STRING_ASCII( &constant_bin[ 893047 ], 23, 0 );
    const_str_digest_410b05d2a9a14659b01e6d2ad73b4d66 = UNSTREAM_STRING_ASCII( &constant_bin[ 893070 ], 6490, 0 );
...
static PyCodeObject *codeobj_ea4cbfd1ead5741a3ced4e4d79854cd6;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_db87ea6d868d2435f6a34cac0e42d1a7 );
    codeobj_ea4cbfd1ead5741a3ced4e4d79854cd6 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_f89d5e2441d80b29b22ac56aab63c345, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
#if PYTHON_VERSION >= 300
    {
        int r = PyObject_SetItem( PyImport_GetModuleDict(), const_str_digest_7d8134536515680674da910bddb241f8, module_numpy$lib$info );
...
#if PYTHON_VERSION >= 300
    UPDATE_STRING_DICT0( moduledict_numpy$lib$info, (Nuitka_StringObject *)const_str_plain___loader__, (PyObject *)&Nuitka_Loader_Type );
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_ea4cbfd1ead5741a3ced4e4d79854cd6;
    ...
    // Frame without reuse.
    frame_ea4cbfd1ead5741a3ced4e4d79854cd6 = MAKE_MODULE_FRAME( codeobj_ea4cbfd1ead5741a3ced4e4d79854cd6, module_numpy$lib$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_ea4cbfd1ead5741a3ced4e4d79854cd6 );
    assert( Py_REFCNT( frame_ea4cbfd1ead5741a3ced4e4d79854cd6 ) == 2 );
    ...
    // Framed code:
    {
        ...
        tmp_mvar_value_1 = GET_STRING_DICT_VALUE( moduledict_numpy$lib$info, (Nuitka_StringObject *)const_str_plain___spec__ );
    ...
    }
    {
        ...
        tmp_mvar_value_2 = GET_STRING_DICT_VALUE( moduledict_numpy$lib$info, (Nuitka_StringObject *)const_str_plain___spec__ );
    ...
    }
    {
        ...
        frame_ea4cbfd1ead5741a3ced4e4d79854cd6->m_frame.f_lineno = 157;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_ea4cbfd1ead5741a3ced4e4d79854cd6 );
#endif
    popFrameStack();

    assertFrameObject( frame_ea4cbfd1ead5741a3ced4e4d79854cd6 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_ea4cbfd1ead5741a3ced4e4d79854cd6, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_ea4cbfd1ead5741a3ced4e4d79854cd6->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_ea4cbfd1ead5741a3ced4e4d79854cd6, exception_lineno );
    }
...
#if 0 && 0
    {
        PyObject *path_value = GET_STRING_DICT_VALUE( moduledict_numpy$lib$info, (Nuitka_StringObject *)const_str_plain___path__ );
