...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_9_complex_call_helper_star_list_star_dict( PyObject **python_pars )
{
    ...
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_9_complex_call_helper_star_list_star_dict );
    return NULL;
    // Return handler code:
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_4_complex_call_helper_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_4_complex_call_helper_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_5_complex_call_helper_pos_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_5_complex_call_helper_pos_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_pos_keywords_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_6_complex_call_helper_pos_keywords_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
